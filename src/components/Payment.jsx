...
export default function Payment({ total, onSuccess, onClose }) {
  ...
  const handleSubmit = (e) => {
    ...
    onSuccess(paymentMethod === 'card' ? 'Credit Card' : 'PayPal');
  };
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="relative bg-white dark:bg-gray-900 rounded-2xl p-6 w-full max-w-md">
        ...
        <div className="mb-4 text-lg font-semibold">Total: {INR.format(total)}</div>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="flex gap-3">
            <button 
              type="button" 
              onClick={onClose}
              className="flex-1 px-4 py-2 rounded-xl border dark:border-gray-800"
            >
              Cancel
            </button>
            <button 
